...
/**
 * POST /api/manager/users/[id]/invite-link
 *
 * Generates a shareable invitation link for a user belonging to a sub-company
...
export async function POST(
  ...
  try {
    ...
    console.error("POST /api/manager/users/[id]/invite-link:", error);
